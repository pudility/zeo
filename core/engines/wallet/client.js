    ...
    return archae.requestPlugins([
      ...
      if (live) {
        ...
        const walletMesh = (() => {
          ...
          const planeMesh = (() => {
            ...
            const mesh = worldUi.makePage(({
              ...
              return {
                type: 'html',
                src: walletRenderer.getWalletPageSrc({loading, error, inputText, inputValue, assets, numTags, page, focus}),
                x: 0,
                y: 0,
                w: WIDTH,
                h: HEIGHT,
        ...
        const itemsMesh = (() => {
          ...
          object.addItem = (position, rotation, scale, asset) => {
            const geometry = (() => {
            ...
            const item = new Item(position, rotation, scale, asset, geometry, grabbable, startTime);
            items.push(item);
          };
              ...
              SIDES.forEach(side => {
                ...
                if (closestItemDistance < 0.2) {
                  ...
                  if (!oldNotification || oldNotification.item !== closestItem) {
                    ...
                    const {asset} = closestItem;
                    const newNotification = notification.addNotification(`This is ${asset}.`);
        ...
        const _trigger = e => {
          ...
          const _clickMenu = () => {
            ...
            if (onclick === 'wallet:focus') {
              ...
              itemsMesh.addItem(position, rotation, scale, asset);
